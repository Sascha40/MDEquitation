    ...
    componentDidMount(){
        ...
        this.props.firebase
            ...
            .get()
                .then(doc => {
                    if (doc.exists) {
                        this.setState({articledata: doc.data()})
        ...
        return (
            <div>
                <Modal open={this.props.open}
                        onOpen={() => {this.props.onOpen; this.getData; }}
                        onClose={this.props.onClose}
                        closeIcon
                        >

                    <Modal.Header>Editer un article</Modal.Header>
...
export default withFirebase(UpdateArticle);