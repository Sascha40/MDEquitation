...
class SignUpFormBase extends React.Component {
    ...
    this.state = {
      ...
      errors: {
        mail: {
          ...
          alreadyUsed: 'Cet email est déjà pris',
        },
        passwordLenght: {
          content:
            'Votre mot de passe doit avoir 8 caractères au minimum, au moins une lettre majuscule, une lettre minuscule, un chiffre et un caractère spécial',
        },
  ...
  onChange = (event) => {
    ...
    if (
      this.validatePasswordMatch(this.state.password, this.state.password2) ===
      false
    ) {
      ...
      <div>
        <Form onSubmit={this.onSubmit.bind(this)}>
          <Segment basic padded={'very'}>
            ...
            <Media at="sm">
              <p className="mt-2" style={{ color: '#4f4f4f' }}>
                {' '}
                En cliquant vous acceptez les termes et conditions ainsi que la
